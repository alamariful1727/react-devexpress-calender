...
// import { ReactHookFormCustomSelect } from '../../components/Shared/CustomSelect';
...
const defaultCurrentDate = new Date(2021, 6, 2, 11, 15);
    ...
    return (
      <Appointments.AppointmentContent {...restProps} data={data}>
        <div className={classes.container}>
          ...
          {/* <div className={classNames(classes.text, classes.content)}>{`Name: ${'Fahim'}`}</div>
          <h1 className="text-xl">Fahim</h1> */}
        </div>
